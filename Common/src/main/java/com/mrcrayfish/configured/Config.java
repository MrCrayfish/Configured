...
public class Config
{
    @SimpleConfig(id = Constants.MOD_ID, name = "client", type = ConfigType.CLIENT, separator = '-')
    ...
    @SimpleConfig(id = Constants.MOD_ID, name = "developer", type = ConfigType.DEDICATED_SERVER, readOnly = true)
