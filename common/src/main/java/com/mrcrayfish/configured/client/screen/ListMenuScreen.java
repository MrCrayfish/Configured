...
public abstract class ListMenuScreen extends TooltipScreen implements IBackgroundTexture
{
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button)
    {
        ...
        {
            Style style = Style.EMPTY.withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, getPlatformSpecificUrl()));
    ...
    private String getPlatformSpecificUrl() {
        String baseUrl = "https://www.curseforge.com/minecraft/mc-mods/";
        if (Platform.isFabric()) {
            return baseUrl + "configured-fabric";
        }
