 ...
 * This isn't a full automatic system. It is just an interface to make such things actually possible.
 */
public interface IModConfig
{
    /**
     * This function expects you to do everything necessary to save the config.
     * If you want an example Lookup {@link com.mrcrayfish.configured.impl.simple.SimpleConfigManager.SimpleConfigImpl}
