...
public class Config
{
    ...
    {
        @SimpleProperty(name = "forceConfiguredMenu", comment = "Forces all config menus to be overridden and generated by Configured. This requires the game to be restarted for the changes to apply.", gameRestart = true)
        public final BoolProperty forceConfiguredMenu = BoolProperty.create(false);

        @SimpleProperty(name = "includeFoldersInSearch", comment = "Include folders when searching in config menus. By default, only entries that link to a config property are shown in searches.")
        public final BoolProperty includeFoldersInSearch = BoolProperty.create(false);

        @SimpleProperty(name = "changedFormatting", comment = "The formatting to apply to the label of a config property that has been changed")
