...
import com.mrcrayfish.configured.client.forge.OptiFineHelper;
...
public class ForgeConfigProvider implements IConfigProvider
{
    ...
    private static void addForgeConfigSetToMap(Mod container, ModConfig.Type type, Consumer<IModConfig> consumer)
    {
